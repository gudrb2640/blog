...
<body>
	<form action="WriteInsertAction.do" method="post" id="form">
		<div class="book">
			<div class="row" >
			...
			<div class="page">
				<input type="text" name="title" id="title" class="title" placeholder="제목" required="required"/><br>
				<hr>
				<textarea rows="100%" cols="80" name="content" id="content" class="content"
					placeholder="태그는 사용 불가능합니다." ></textarea>
			</div>
		</div>
	</form>
</body>
